...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Cmdlets
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPolicySetDefinition_Get" /> cmdlet class.
        /// </summary>
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.PolicySetDefinitionsGet(Name, SubscriptionId, onOk, onDefault, this, Pipeline);
