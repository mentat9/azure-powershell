...
namespace Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.Api20210601
{
    ...
    public partial class PolicyDefinitionProperties
    {
        ...
        internal PolicyDefinitionProperties(Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonObject json)
        {
            ...
            {_policyRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonObject>("policyRule"), out var __jsonPolicyRule) ? Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.Any.FromJson(__jsonPolicyRule) : PolicyRule;}
            {_metadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Policy.Runtime.Json.JsonObject>("metadata"), out var __jsonMetadata) ? Microsoft.Azure.PowerShell.Cmdlets.Policy.Models.Any.FromJson(__jsonMetadata) : Metadata;}
